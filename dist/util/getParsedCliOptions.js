...
var require_error = __commonJS({
  "node_modules/commander/lib/error.js"(exports) {
    ...
    var InvalidArgumentError = /* @__PURE__ */ __name(class InvalidArgumentError extends CommanderError {
      constructor(message) {
...
var require_suggestSimilar = __commonJS({
  "node_modules/commander/lib/suggestSimilar.js"(exports) {
    ...
    function editDistance(a, b) {
      ...
      for (let j1 = 1; j1 <= b.length; j1++) {
        for (let i1 = 1; i1 <= a.length; i1++) {
          let cost = 1;
          if (a[i1 - 1] === b[j1 - 1]) {
            cost = 0;
          } else {
...
var require_command = __commonJS({
  "node_modules/commander/lib/command.js"(exports) {
    ...
    var Command = /* @__PURE__ */ __name(class Command2 extends EventEmitter {
      constructor(name) {
        super();
        this.commands = [];
        this.options = [];
      ...
      parseOptions(argv) {
        ...
        while (args.length) {
          ...
          if (maybeOption(arg)) {
            ...
            if (option) {
              if (option.required) {
                ...
                this.emit(`option:${option.name()}`, value1);
              } else {
          ...
          if (arg.length > 2 && arg[0] === "-" && arg[1] !== "-") {
            const option1 = this._findOption(`-${arg[1]}`);
            if (option1) {
              if (option1.required || option1.optional && this._combineFlagAndOptionalValue) {
                this.emit(`option:${option1.name()}`, arg.slice(2));
              } else {
                this.emit(`option:${option1.name()}`);
...
var getParsedCliOptions_exports = {};
__export(getParsedCliOptions_exports, {
  getParsedCliOptions: () => getParsedCliOptions
});
module.exports = __toCommonJS(getParsedCliOptions_exports);
var getParsedCliOptions = /* @__PURE__ */ __name(() => {
  const { program } = require_commander();
