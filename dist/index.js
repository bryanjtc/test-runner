  ...
  "node_modules/locate-path/index.js"(exports, module2) {
    ...
    module2.exports = (paths, options) => __async(exports, null, function* () {
      ...
      return pLocate(paths, (path_) => __async(exports, null, function* () {
        try {
          const stat = yield statFn(path2.resolve(options.cwd, path_));
...
var require_path_exists = __commonJS({
  "node_modules/find-up/node_modules/path-exists/index.js"(exports, module2) {
    ...
    module2.exports = (path2) => __async(exports, null, function* () {
      try {
        yield pAccess(path2);
        return true;
      } catch (_) {
...
var require_async = __commonJS({
  "node_modules/resolve/lib/async.js"(exports, module2) {
    ...
    module2.exports = /* @__PURE__ */ __name(function resolve2(x, options, callback) {
      var cb = callback;
      var opts = options;
...
var getTestRunnerConfig = /* @__PURE__ */ __name((configDir) => {
  ...
  testRunnerConfig = (0, import_core_common.serverRequire)((0, import_path2.join)((0, import_path2.resolve)(configDir), "test-runner"));
  loaded = true;
  return testRunnerConfig;
}, "getTestRunnerConfig");
